...
/**
 * Profile is the full connection description carried by an arno://connect URI.
...
data class Profile(
    ...
    companion object {
        const val SCHEME = "arno"

        /** parse decodes an arno://connect?... URI. */
        fun parse(raw: String): Profile {
            val uri = Uri.parse(raw.trim())
            require(uri.scheme == SCHEME) { "not an arno:// URI" }
